...
export default async function AdminPage() {
  ...
  if (isMock()) {
    ...
    const { data } = await createAdminSupabase()
      .from("operaciones")
      .select(
        "id, code, evento, comprador_alias, vendedor_alias, monto, cantidad, fee, cuenta_debitar, status, entrada_recibida_at, pago_confirmado_at, cerrada_at, entrada_recibida_por, pago_confirmado_por, cerrada_por, fecha_evento, notas, ticket_id, tipo, cliente_id, cliente_email, sector, created_at, updated_at"
      )
