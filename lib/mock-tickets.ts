...
export const MOCK_TICKETS: Ticket[] = [
  // Mundial 2026
  { id: "1001::1", evento: "Match 12, Group A - Argentina vs Chile", competicion: "FIFA World Cup 2026", fecha: d(20), ciudad: "Estadio Azteca, Ciudad de México (MEX)", categoria: "Category 1", zona_color: "#E4572E", precio_final: 720, stock: 4, estado: "book", source: "portal" },
  { id: "1001::2", evento: "Match 12, Group A - Argentina vs Chile", competicion: "FIFA World Cup 2026", fecha: d(20), ciudad: "Estadio Azteca, Ciudad de México (MEX)", categoria: "Category 2", zona_color: "Zona Azul", precio_final: 540, stock: 2, estado: "book", source: "portal" },
  ...
  // Champions
  { id: "3001::1", evento: "Real Madrid vs Manchester City", competicion: "UEFA Champions League", fecha: d(9), ciudad: "Santiago Bernabéu, Madrid (ESP)", categoria: "Lateral Alto", zona_color: "verde", precio_final: 480, stock: 1, estado: "book", source: "portal", imagen_url: MOCK_MAPA },
  { id: "3001::2", evento: "Real Madrid vs Manchester City", competicion: "UEFA Champions League", fecha: d(9), ciudad: "Santiago Bernabéu, Madrid (ESP)", categoria: "Fondo Norte", zona_color: "Tribuna Alta", precio_final: 295, stock: 3, estado: "book", source: "portal" },
