...
const en = {
  ...
  lp: {
    ...
    consentMid: " and the ",
    consentError: "You must accept the terms and conditions to continue.",
...
const es: typeof en = {
  ...
  lp: {
    ...
    enviando: "Enviando…",
    consentPre: "Leí y acepto los ",
    consentMid: " y la ",
    consentError: "Tenés que aceptar los términos y condiciones para continuar.",
